...
internal object Res {
  ...
  public suspend fun readBytes(path: String): ByteArray =
      readResourceBytes("composeResources/kotlinmultiplatform.composeapp.generated.resources/" +
      path)
  ...
  public fun getUri(path: String): String =
      getResourceUri("composeResources/kotlinmultiplatform.composeapp.generated.resources/" + path)
